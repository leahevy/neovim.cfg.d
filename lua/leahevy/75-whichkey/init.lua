...
local mappings = {
  ...
  ["f"] = {
    "<cmd>lua require('telescope.builtin').find_files{require('telescope.themes').get_dropdown{previewer = true}, hidden=true, file_ignore_patterns = { 'node%_modules/.*', '.git/.*' }}<cr>",
    "Find files",
  },
